...
class TestSearch():
    ...
    def setup_class(self):
        # 实例化统一入口类 实名
        self.serach=PageIn().page_get_pageserarch()
    ...
    def test_search(self,text):
        ...
        # 匿名  多次调用不推荐使用匿名
        # PageIn().page_get_pageserarch().page_click_search_btn()
        # PageIn().page_get_pageserarch().page_input_text()
        # PageIn().page_get_pageserarch().page_click_back_btn()